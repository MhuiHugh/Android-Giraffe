...
public class MDAlertDialog {
    ...
    public MDAlertDialog(Builder builder) {
        ...
        mDialogView = View.inflate(mBuilder.getContext(), R.layout.dialog_md, null);
        ...
        mDialogView.setMinimumHeight((int) (DensityUtil.getScreenHeight() * builder.getHeight()));
    ...
    public static class Builder {
        ...
        public Builder(Context context) {
            ...
            mContext = context;
            titleText = "提示";
            titleTextColor = ContextCompat.getColor(mContext,R.color.colorSix);
            contentText = "";
            contentTextColor = ContextCompat.getColor(mContext, R.color.colorThree);
            leftButtonText = "取消";
            leftButtonTextColor = ContextCompat.getColor(mContext, R.color.colorSix);
            rightButtonText = "确定";
