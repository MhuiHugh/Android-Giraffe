...
public class NormalAlertDialog {
    ...
    public NormalAlertDialog(Builder builder) {
        ...
        mDialogView.setMinimumHeight((int) (DensityUtil
                .getScreenHeight() * builder.getHeight()));
        mDialog.setContentView(mDialogView);

        Window dialogWindow = mDialog.getWindow();
        WindowManager.LayoutParams lp = dialogWindow.getAttributes();
        lp.width = (int) (DensityUtil.getScreenWidth() * builder.getWidth());
    ...
    private void initDialog(Builder builder) {
        ...
        mRightBtn.setBackgroundResource(mBuilder.getRightButtonBackground());
    ...
    public static class Builder {
        ...
        private DialogInterface.OnSingleClickListener<NormalAlertDialog> closeClickListener;
        ...
        public Builder(Context context) {
            ...
            mContext = context;
            titleText = "温馨提示";
            titleTextColor = ContextCompat.getColor(mContext, R.color.colorThree);
            rightButtonBackground = R.drawable.widget_dialog_right_selector;
            contentText = "";
            contentTextColor = ContextCompat.getColor(mContext, R.color.colorNine);
            isSingleMode = false;
            singleButtonText = "确定";
            singleButtonTextColor = ContextCompat.getColor(mContext, R.color.colorSix);
            leftButtonText = "取消";
            leftButtonTextColor = ContextCompat.getColor(mContext, R.color.colorNine);
            rightButtonText = "确定";
            rightButtonTextColor = ContextCompat.getColor(mContext, R.color.colorThree);
        ...
        public DialogInterface.OnSingleClickListener<NormalAlertDialog> getCloseClickListener() {
            return closeClickListener;
        }

        public Builder setCloseClickListener(DialogInterface.OnSingleClickListener<NormalAlertDialog> closeClickListener) {
        ...
        public Builder setSingleListener(DialogInterface.OnSingleClickListener<NormalAlertDialog> singleListener) {
        ...
        public Builder setRightButtonBackground(int color) {
            this.rightButtonBackground = color;
            return this;
        }
