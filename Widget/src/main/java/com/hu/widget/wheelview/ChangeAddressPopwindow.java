package com.hu.widget.wheelview;
...
import com.hu.widget.R;
import com.hu.widget.wheelview.adapter.AbstractWheelTextAdapter1;
...
public class ChangeAddressPopwindow extends PopupWindow implements View.OnClickListener {
    ...
    public ChangeAddressPopwindow(final Context context) {
        ...
        View view = View.inflate(context, R.layout.popwindow_changeaddress_layout, null);
     ...
     * @return
     */
    public String readStrFromAsset(String fileName) {
    ...
    private class AddressTextAdapter extends AbstractWheelTextAdapter1 {
        ...
        protected AddressTextAdapter(Context context, ArrayList<String> list, int currentItem, int maxsize, int minsize) {
            super(context, R.layout.item_popchangeaddress_birth_year, NO_RESOURCE, currentItem, maxsize, minsize);
            this.list = list;
    ...
    private void initJsonData() {
        try {
            mJsonObj = new JSONObject(readStrFromAsset("china_utf8.json"));
