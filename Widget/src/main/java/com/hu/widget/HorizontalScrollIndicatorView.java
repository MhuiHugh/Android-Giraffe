    ...
    public void onClick(View view) {
        if (mOnClickListener != null) {
            for (int i = 0; i < mContainer.getChildCount(); i++) {
                mContainer.getChildAt(i).findViewById(R.id.collage_item_colorselect).setBackgroundColor(mContext.getResources().getColor(R.color.transparency));
            }
            mAdapter.setCurrentIndex(mViewPos.get(view));
            view.findViewById(R.id.collage_item_colorselect).setBackgroundColor(mContext.getResources().getColor(R.color.bulue));
